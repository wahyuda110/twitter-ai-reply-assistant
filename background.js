  ...
  if (tweetText) {
    ...
    switch (responseType) {
      case 'like':
        ...
        break;
      case 'support':
        prompt += 'Rewrite this for busy scrollers with low attention spans. If it is not skimmable, it is invisible. IMPORTANT: Avoid using hyphens (-), apostrophes (\'s), hashtags (#), and links in your response. Use simple, clean formatting. Maximum 200 characters.';
        break;
      case 'dislike':
        prompt += 'Give me 1 headline that builds curiosity and urgency. Hooks = views. Views = growth. IMPORTANT: Create only ONE complete response without any numbering or parts. Avoid using hyphens (-), apostrophes (\'s), hashtags (#), and links in your response. Use simple, clean formatting. Maximum 200 characters.';
        break;
      case 'suggestion':
        prompt += 'Break this into a bold, punchy list that keeps people reading. Format is leverage. Structure sells. IMPORTANT: Avoid using hyphens (-), apostrophes (\'s), hashtags (#), and links in your response. Use simple, clean formatting. Maximum 200 characters.';
        break;
      case 'question':
        prompt += 'Highlight the strongest line. Cut the weakest one. Edit like a sniper. One shot, one kill. IMPORTANT: Avoid using hyphens (-), apostrophes (\'s), hashtags (#), and links in your response. Use simple, clean formatting. Maximum 200 characters.';
        break;
      case 'tone':
        prompt += 'Create an R3 comment format reply: Short (1-2 sentences), casual style, all lowercase, use abbreviations like u, ur, fr, tbh, btw, rn, gonna, etc. Be positive, supportive, and relevant. Sometimes open discussion or mention the project. Sometimes use supportive words like bro, mate, or sir. IMPORTANT: Do NOT include "R3:" in your response, just provide the comment directly without any prefix. Avoid emojis, excessive punctuation, and dashes. Maximum 200 characters.';
        break;
      case 'series':
        prompt += 'Turn this into content that teaches and sells without sounding desperate. Strategy over spam. Always. IMPORTANT: Create only ONE complete response without any numbering or parts. Avoid using hyphens (-), apostrophes (\'s), hashtags (#), and links in your response. Use simple, clean formatting. Maximum 200 characters.';
        break;
      default:
    ...
    switch (responseType) {
      case 'like':
        ...
        break;
      case 'support':
        prompt += 'Write for busy scrollers with low attention spans. If it is not skimmable, it is invisible. IMPORTANT: Avoid using hyphens (-), apostrophes (\'s), hashtags (#), and links in your response. Use simple, clean formatting. Maximum 200 characters.';
        break;
      case 'dislike':
        prompt += 'Create 1 headline that builds curiosity and urgency. Hooks = views. Views = growth. IMPORTANT: Create only ONE complete response without any numbering or parts. Avoid using hyphens (-), apostrophes (\'s), hashtags (#), and links in your response. Use simple, clean formatting. Maximum 200 characters.';
        break;
      case 'suggestion':
        prompt += 'Write as a bold, punchy list that keeps people reading. Format is leverage. Structure sells. IMPORTANT: Avoid using hyphens (-), apostrophes (\'s), hashtags (#), and links in your response. Use simple, clean formatting. Maximum 200 characters.';
        break;
      case 'question':
        prompt += 'Highlight the strongest line. Cut the weakest one. Edit like a sniper. One shot, one kill. IMPORTANT: Avoid using hyphens (-), apostrophes (\'s), hashtags (#), and links in your response. Use simple, clean formatting. Maximum 200 characters.';
        break;
      case 'tone':
        prompt += 'Create content in R3 comment format: Short (1-2 sentences), casual style, all lowercase, use abbreviations like u, ur, fr, tbh, btw, rn, gonna, etc. Be positive, supportive, and relevant to Web3/crypto/builder communities. Sometimes open discussion. Sometimes use supportive words like bro, mate, or sir. IMPORTANT: Do NOT include "R3:" in your response, just provide the comment directly without any prefix. Avoid emojis, excessive punctuation, and dashes. Maximum 200 characters.';
        break;
      case 'series':
        prompt += 'Create content that teaches and sells without sounding desperate. Strategy over spam. Always. IMPORTANT: Create only ONE complete response without any numbering or parts. Avoid using hyphens (-), apostrophes (\'s), hashtags (#), and links in your response. Use simple, clean formatting. Maximum 200 characters.';
        break;
      default:
