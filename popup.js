...
<<<<<<< HEAD
            ...
            if (!apiKey) {
                updateStatus('error', 'Please enter Azure OpenAI API key first');
                return;
            }
            
            // For Azure, we'll pass the pre-configured settings as model
            model = {
                endpoint: 'https://okegas.openai.azure.com/',
